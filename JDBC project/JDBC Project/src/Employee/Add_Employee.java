...
class Add_Employee implements ActionListener{
    ...
    Add_Employee(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Employee/icon/add_employee.jpg"));
        Image i2 = img.getImage().getScaledInstance(900,700,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        id15.setIcon(i3);

        id8 = new JLabel("New Employee Employee Detail");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                ...
                JOptionPane.showMessageDialog(null,"Employee_Detail Successfully Inserted");
                f.setVisible(false);
                new Employee_Detail();
            }catch(Exception ee){
